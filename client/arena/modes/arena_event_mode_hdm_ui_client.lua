...
hdmUI = {
    ...
    create = function()
        if not hdmUI.itemlistElement then
            local itemlistData = hdmUI.itemlistData
            ...
            hdmUI.itemlistElement = itemlistElement

            local eventHandlers = hdmUI.eventHandlers
            ...
            local settings = hdmUI.settings

            local keyBinds = hdmUI.keyBinds
    ...
    destroy = function()
        if hdmUI.itemlistElement then
            ...
            hdmUI.itemlistElement:destroy()

            hdmUI.itemlistElement = nil

            hdmUI.itemlistData = nil

            hdmUI.prepareItemlistData()
    ...
    getElementData = function(element, key)
        ...
        if not data then
            ...
            if data then
                hdmUI.setElementData(element, key, data)
            end
        end
    ...
    prepareItemlistData = function()
        if not hdmUI.itemlistData then
            local settings = hdmUI.settings
            local fonts = hdmUI.fonts
            ...
            local itemlistData = {
                ...
                events = {
                    ...
                    onAnimationRender = function(self)
                        ...
                        do
                            local coreElement = hdmUI.getElementData(event1.data.arenaElement, "coreElement", false)
                            ...
                            if isElement(coreElement) then
                                ...
                                do
                                    ...
                                    local state = hdmUI.getElementData(coreElement, "state", false)
                                    ...
                                    local round = hdmUI.getElementData(coreElement, "round", false)
                    ...
                    sortPlayers = function(self)
                        ...
                        tableSort(data,
                            function(a, b)
                                ...
                                local aPoints = hdmUI.getElementData(aPlayer, "points", false) or 0
                                local bPoints = hdmUI.getElementData(bPlayer, "points", false) or 0
                            ...
                            local playerRenderer = function(self, cell, cellX, cellY, cellSx, cellSy, animationProgress, subPixel)
                                ...
                                do
                                    ...
                                    do
                                        ...
                                        dxDrawText(hdmUI.getElementData(player, "points", false) or "-", x, y, x, y, tocolor(255, 255, 255, animationProgress), 1*rel, font, "right", "center", false, false, false, true)
                                    end
                                    ...
                                    do
                                        ...
                                        if isElement(texture) then
                                            ...
                                            dxDrawImage(mathFloor(x), mathFloor(y - imgSize/2), mathFloor(imgSize), mathFloor(imgSize), texture, 0, 0, 0, tocolor(204, 105, 105, animationProgress*(hdmUI.getElementData(player, "state", false) == "alive" and 1 or 0.5)))
                                        end
                                    end
                                end
                            end
                                ...
                                do
                                    ...
                                    do
                                        ...
                                        for i, player in pairs(getPlayersInTeam(team)) do
                                            if hdmUI.getElementData(player, "state", false) == "alive" then
                                                count = count + 1
                                            end
                                        end
            ...
            hdmUI.itemlistData = itemlistData
        end
    end,
    ...
    eventHandlers = {
        ...
        onClientElementDataChange = function(key, oldValue, newValue)
            hdmUI.setElementData(source, key, newValue)
        end,

        onClientRestore = function()
            hdmUI.itemlistElement.custom.updateRenderTarget(hdmUI.itemlistElement)
        end
    },

    keyBinds = {
        toggle = function(key, state)
            hdmUI.itemlistElement:setAnimationState(not hdmUI.itemlistElement.animation.state)

            --[[ local itemlistElement = hdmUI.itemlistElement
