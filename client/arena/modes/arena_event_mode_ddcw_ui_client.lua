...
ddcwUI = {
    ...
    create = function()
        if not ddcwUI.itemlistElement then
            local itemlistData = ddcwUI.itemlistData
            ...
            ddcwUI.itemlistElement = itemlistElement

            local eventHandlers = ddcwUI.eventHandlers
            ...
            local settings = ddcwUI.settings

            local keyBinds = ddcwUI.keyBinds
    ...
    destroy = function()
        if ddcwUI.itemlistElement then
            local eventHandlers = ddcwUI.eventHandlers
            ...
            ddcwUI.itemlistElement:destroy()

            ddcwUI.itemlistElement = nil

            ddcwUI.itemlistData = nil

            ddcwUI.prepareItemlistData()
    ...
    getElementData = function(element, key)
        ...
        if not data then
            ...
            if data then
                ddcwUI.setElementData(element, key, data)
            end
        end
    ...
    prepareItemlistData = function()
        if not ddcwUI.itemlistData then
            local settings = ddcwUI.settings
            local fonts = ddcwUI.fonts
            ...
            local itemlistData = {
                ...
                events = {
                    ...
                    onAnimationRender = function(self)
                        ...
                        do
                            local coreElement = ddcwUI.getElementData(event1.data.arenaElement, "coreElement", false)
                            ...
                            if isElement(coreElement) then
                                ...
                                do
                                    ...
                                    local state = ddcwUI.getElementData(coreElement, "state", false)
                                    ...
                                    local round = ddcwUI.getElementData(coreElement, "round", false)
                                ...
                                local teamsCount = ddcwUI.getElementData(coreElement, "teamsCount", false)
    
                                if teamsCount then
                                    local resultStrings = {}

                                    for i = 1, teamsCount do
                                        local teamElement = ddcwUI.getElementData(coreElement, "eventTeam" .. i, false)

                                        resultStrings[i] = "#" .. rgbToHex(getTeamColor(teamElement)) .. (ddcwUI.getElementData(teamElement, "tag", false) or "") .. " #FFFFFF" .. tostring(ddcwUI.getElementData(teamElement, "points", false) or 0)
                                    end
                ...
                custom = {
                    ...
                    sortPlayers = function(self)
                        ...
                        local sortingFunction = function(a, b)
                            ...
                            local aPoints = ddcwUI.getElementData(aPlayer, "points", false) or 0
                            local bPoints = ddcwUI.getElementData(bPlayer, "points", false) or 0
                            ...
                            local playerRenderer = function(self, cell, cellX, cellY, cellSx, cellSy, animationProgress, subPixel)
                                ...
                                do
                                    ...
                                    do
                                        ...
                                        dxDrawText(ddcwUI.getElementData(player, "points", false) or "-", x, y, x, y, tocolor(255, 255, 255, animationProgress), 1*rel, font, "right", "center", false, false, false, true)
                                    end
                                    ...
                                    do
                                        ...
                                        if isElement(texture) then
                                            ...
                                            dxDrawImage(mathFloor(x), mathFloor(y - imgSize/2), mathFloor(imgSize), mathFloor(imgSize), texture, 0, 0, 0, tocolor(204, 105, 105, animationProgress*(ddcwUI.getElementData(player, "state", false) == "alive" and 1 or 0.5)))
                                        end
                                    end
                                end
                            end
                                ...
                                do
                                    ...
                                    do
                                        ...
                                        for i, player in pairs(getPlayersInTeam(team)) do
                                            if ddcwUI.getElementData(player, "state", false) == "alive" then
                                                count = count + 1
                                            end
                                        end
            ...
            ddcwUI.itemlistData = itemlistData
        end
    end,
    ...
    eventHandlers = {
        ...
        onClientElementDataChange = function(key, oldValue, newValue)
            ddcwUI.setElementData(source, key, newValue)
        end,

        onClientRestore = function()
            ddcwUI.itemlistElement.custom.updateRenderTarget(ddcwUI.itemlistElement)
        end
    },

    keyBinds = {
        toggle = function(key, state)
            ddcwUI.itemlistElement:setAnimationState(not ddcwUI.itemlistElement.animation.state)

            --[[ local itemlistElement = ddcwUI.itemlistElement
