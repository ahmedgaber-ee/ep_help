...
wffUI = {
    ...
    create = function()
        if not wffUI.itemlistElement then
            local itemlistData = wffUI.itemlistData
            ...
            wffUI.itemlistElement = itemlistElement

            local eventHandlers = wffUI.eventHandlers
            ...
            local settings = wffUI.settings

            local keyBinds = wffUI.keyBinds
    ...
    destroy = function()
        if wffUI.itemlistElement then
            ...
            wffUI.itemlistElement:destroy()

            wffUI.itemlistElement = nil

            wffUI.itemlistData = nil

            wffUI.prepareItemlistData()
    ...
    getElementData = function(element, key)
        ...
        if not data then
            ...
            if data then
                wffUI.setElementData(element, key, data)
            end
        end
    ...
    prepareItemlistData = function()
        if not wffUI.itemlistData then
            local settings = wffUI.settings
            local fonts = wffUI.fonts
            ...
            local itemlistData = {
                ...
                events = {
                    ...
                    onAnimationRender = function(self)
                        ...
                        do
                            local coreElement = wffUI.getElementData(event1.data.arenaElement, "coreElement", false)
                            ...
                            if isElement(coreElement) then
                                ...
                                do
                                    ...
                                    local state = wffUI.getElementData(coreElement, "state", false)
                                    ...
                                    local round = wffUI.getElementData(coreElement, "round", false)
                    ...
                    sortPlayers = function(self)
                        ...
                        tableSort(data,
                            function(a, b)
                                ...
                                local aPoints = wffUI.getElementData(aPlayer, "points", false) or 0
                                local bPoints = wffUI.getElementData(bPlayer, "points", false) or 0
                            ...
                            local playerRenderer = function(self, cell, cellX, cellY, cellSx, cellSy, animationProgress, subPixel)
                                ...
                                do
                                    ...
                                    do
                                        ...
                                        dxDrawText(wffUI.getElementData(player, "points", false) or "-", x, y, x, y, tocolor(255, 255, 255, animationProgress), 1*rel, font, "right", "center", false, false, false, true)
                                    end
                                    ...
                                    do
                                        ...
                                        if isElement(texture) then
                                            ...
                                            dxDrawImage(mathFloor(x), mathFloor(y - imgSize/2), mathFloor(imgSize), mathFloor(imgSize), texture, 0, 0, 0, tocolor(204, 105, 105, animationProgress*(wffUI.getElementData(player, "state", false) == "alive" and 1 or 0.5)))
                                        end
                                    end
                                end
                            end
                                ...
                                do
                                    ...
                                    do
                                        ...
                                        for i, player in pairs(getPlayersInTeam(team)) do
                                            if wffUI.getElementData(player, "state", false) == "alive" then
                                                count = count + 1
                                            end
                                        end
            ...
            wffUI.itemlistData = itemlistData
        end
    end,
    ...
    eventHandlers = {
        ...
        onClientElementDataChange = function(key, oldValue, newValue)
            wffUI.setElementData(source, key, newValue)
        end,

        onClientRestore = function()
            wffUI.itemlistElement.custom.updateRenderTarget(wffUI.itemlistElement)
        end
    },

    keyBinds = {
        toggle = function(key, state)
            wffUI.itemlistElement:setAnimationState(not wffUI.itemlistElement.animation.state)

            --[[ local itemlistElement = wffUI.itemlistElement
