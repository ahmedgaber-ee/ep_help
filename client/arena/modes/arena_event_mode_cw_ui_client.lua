...
cwUI = {
    ...
    create = function()
        if not cwUI.itemlistElement then
            local itemlistData = cwUI.itemlistData
            ...
            cwUI.itemlistElement = itemlistElement

            local eventHandlers = cwUI.eventHandlers
            ...
            local settings = cwUI.settings

            local keyBinds = cwUI.keyBinds
    ...
    destroy = function()
        if cwUI.itemlistElement then
            ...
            cwUI.itemlistElement:destroy()

            cwUI.itemlistElement = nil

            cwUI.itemlistData = nil

            cwUI.prepareItemlistData()
    ...
    getElementData = function(element, key)
        ...
        if not data then
            ...
            if data then
                cwUI.setElementData(element, key, data)
            end
        end
    ...
    prepareItemlistData = function()
        if not cwUI.itemlistData then
            ...
            local itemlistData = {
                ...
                events = {
                    ...
                    onAnimationRender = function(self)
                        ...
                        do
                            local coreElement = cwUI.getElementData(event1.data.arenaElement, "coreElement", false)
                            ...
                            if isElement(coreElement) then
                                ...
                                do
                                    ...
                                    local state = cwUI.getElementData(coreElement, "state", false)
                                    ...
                                    local round = cwUI.getElementData(coreElement, "round", false)
                                ...
                                local teamsCount = cwUI.getElementData(coreElement, "teamsCount", false)
    
                                if teamsCount then
                                    local resultStrings = {}

                                    for i = 1, teamsCount do
                                        local teamElement = cwUI.getElementData(coreElement, "eventTeam" .. i, false)

                                        resultStrings[i] = "#" .. rgbToHex(getTeamColor(teamElement)) .. (cwUI.getElementData(teamElement, "tag", false) or "") .. " #FFFFFF" .. tostring(cwUI.getElementData(teamElement, "points", false) or 0)
                                    end
                ...
                custom = {
                    ...
                    sortPlayers = function(self)
                        ...
                        local sortingFunction = function(a, b)
                            ...
                            local aPoints = cwUI.getElementData(aPlayer, "points", false) or 0
                            local bPoints = cwUI.getElementData(bPlayer, "points", false) or 0
                            ...
                            local playerRenderer = function(self, cell, cellX, cellY, cellSx, cellSy, animationProgress, subPixel)
                                ...
                                do
                                    ...
                                    do
                                        ...
                                        dxDrawText(cwUI.getElementData(player, "points", false) or "-", x, y, x, y, tocolor(255, 255, 255, animationProgress), 1*rel, font, "right", "center", false, false, false, true)
                                    end
                                    ...
                                    do
                                        ...
                                        if isElement(texture) then
                                            ...
                                            dxDrawImage(mathFloor(x), mathFloor(y - imgSize/2), mathFloor(imgSize), mathFloor(imgSize), texture, 0, 0, 0, tocolor(204, 105, 105, animationProgress*(cwUI.getElementData(player, "state", false) == "alive" and 1 or 0.5)))
                                        end
                                    end
                                end
                            end
                                ...
                                do
                                    ...
                                    do
                                        ...
                                        for i, player in pairs(getPlayersInTeam(team)) do
                                            if cwUI.getElementData(player, "state", false) == "alive" then
                                                count = count + 1
                                            end
                                        end
            ...
            cwUI.itemlistData = itemlistData
        end
    end,
    ...
    eventHandlers = {
        ...
        onClientElementDataChange = function(key, oldValue, newValue)
            cwUI.setElementData(source, key, newValue)
        end,

        onClientRestore = function()
            cwUI.itemlistElement.custom.updateRenderTarget(cwUI.itemlistElement)
        end
    },

    keyBinds = {
        toggle = function(key, state)
            cwUI.itemlistElement:setAnimationState(not cwUI.itemlistElement.animation.state)

            --[[ local itemlistElement = cwUI.itemlistElement
